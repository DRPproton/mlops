...
#### I use the Command Palette in VSCode

- Press Ctrl+Shift+P (Windows/Linux) or Cmd+Shift+P (Mac) to open the Command Palette.
    - Type "Export"
    - Choose "Export to Python Script"
    - A python file will pop up
    - Save the file
...
#### Docker Commands
> docker build -t mlops_w4:v1 .

> docker run -it --rm mlops_w4:v1 2023 5
